      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full bg-white text-black py-3 font-bold flex items-center justify-center space-x-2 hover:bg-gray-200 transition-all duration-300 disabled:opacity-50"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            {googleLoading ? (
